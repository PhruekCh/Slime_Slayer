...
class Ball:
    def __init__(self, size, x, y, vx, vy, color, id, gif_path):
        ...
        self.screen.addshape("pics/slime_red.gif")
        self.screen.addshape("pics/slime_blue.gif")
        self.screen.addshape("pics/slime_green.gif")
        self.screen.addshape("pics/slime_purple.gif")
        self.turtle.penup()
    ...
    def move(self, dt):
        ...
        # Move the turtle representation if it exists
        if self.turtle:
            self.turtle.goto(self.x, self.y)
